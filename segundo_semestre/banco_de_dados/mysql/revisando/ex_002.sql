-- Considere uma tabela vendas com as colunas id_venda, id_cliente, produto e valor.
-- Escreva uma consulta para listar cada id_cliente, seguido de uma lista de todos os produtos comprados por esse cliente. Ordene os clientes por id_cliente em ordem crescente.
